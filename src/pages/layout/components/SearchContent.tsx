...
import { addHistory, clearHistory } from '../headerStoreSlice'
...
export default function SearchContent({ sonList, handleDestory, keywords }) {
  ...
  // 从store中获取搜索历史
  const searchHistory = useSelector(state => state.headerStoreSlice.searchHistory)
    ...
    <div className='searchContainer'>
      {
        ...
        <>
          <p className='hotSearch'>
            搜索历史
            <DeleteOutlined style={{ cursor: 'pointer' }} onClick={() => dispatch(clearHistory())} />
          </p>
